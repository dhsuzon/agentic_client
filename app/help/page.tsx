  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-12">
      <div className="mb-8 text-center">
        <h1 className="mb-3 text-4xl font-bold text-foreground dark:text-white">Help & Support</h1>
        <p className="text-foreground/60 dark:text-muted">
      ...
      <Card.Root className="rounded-xl border border-default-200">
        <Card.Content className="flex flex-col items-center gap-4 p-6 text-center">
          <Card.Title className="text-base font-semibold text-foreground dark:text-white">Still need help?</Card.Title>
          <Card.Description className="text-sm text-foreground/60 dark:text-muted">
