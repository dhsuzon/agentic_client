...
export default function PrivacyPage() {
  return (
    <div className="mx-auto max-w-3xl px-4 py-12">
      <h1 className="mb-6 text-4xl font-bold text-foreground dark:text-white">Privacy Policy</h1>
      <p className="mb-2 text-sm text-foreground/60">Last updated: July 2026</p>

      <div className="space-y-6 text-sm leading-relaxed text-foreground/80">
        <section>
          <h2 className="mb-2 text-lg font-semibold text-foreground dark:text-white">1. Information We Collect</h2>
        ...
        <section>
          <h2 className="mb-2 text-lg font-semibold text-foreground dark:text-white">2. How We Use Your Information</h2>
        ...
        <section>
          <h2 className="mb-2 text-lg font-semibold text-foreground dark:text-white">3. Data Sharing</h2>
        ...
        <section>
          <h2 className="mb-2 text-lg font-semibold text-foreground dark:text-white">4. Data Security</h2>
        ...
        <section>
          <h2 className="mb-2 text-lg font-semibold text-foreground dark:text-white">5. Your Rights</h2>
        ...
        <section>
          <h2 className="mb-2 text-lg font-semibold text-foreground dark:text-white">6. Contact</h2>
